...
#define W25Q128JV_QSPI_COUNT_LIMIT          (10)
...
W25Q128JV_EXT uint8_t W25Q128JV_PageProgram(uint8_t* pData, uint32_t WriteAddr, uint32_t Size);

W25Q128JV_EXT uint8_t W25Q128JV_ReadData(uint8_t* pData, uint32_t ReadAddr, uint32_t Size);
